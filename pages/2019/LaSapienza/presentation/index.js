...
const images = {
  ...
  FlagOfChina: require("../../../../assets/Flag_of_China.svg"),
  BlockedDomainsInIran: require("../assets/BlockedDomainsInIran.svg"),

  NettestGroupCircumvention: require("../../../../assets/NettestGroupCircumvention.svg"),
  ...
  OONIExplorerScreenshot: require("../../../../assets/ooni-explorer-screenshot.png"),
  ...
  WomenOnWavesCover: require('../../../../assets/wow-cover-image.png'),
  WomenOnWavesBlockingChart: require('../../../../assets/wow-global-blocking-chart.png'),
    ...
    return (
      <Deck transition={["zoom", "slide"]} transitionDuration={500} theme={theme}>
        <Slide transition={["zoom"]} bgColor="white">
          ...
          <Heading size={6}>
          Roma, 9th December 2019
          </Heading>
          <Heading size={6}>
          Arturo Filastò
          </Heading>
          <Image width='300px' style={{paddingTop: '30px'}} src={images.OONIHorizontalColor} />
          <Text style={{color: colors.palette.blue5}}>https://slides.ooni.io/2019/LaSapienza</Text>
        </Slide>
        ...
        <Slide transition={["fade"]} bgColor="white">
          ...
          <Layout>
            ...
            <NettestType>
              <Image src={images.NettestGroupCircumvention} height="145px" />
        ...
        <Slide transition={["fade"]} bgImage={images.FlagOfChina} bgDarken={0.7} bgSize='120%'>
          <Notes>
          Simone
          </Notes>
          <Appear fid="2" order={2}>
            <CountryReportFinding>Previously, the block was only for the Chinese Wikipedia (zh.wikipedia.org), but now expanded to *.wikipedia.org.</CountryReportFinding>
          </Appear>
          <Appear fid="3" order={3}>
            <CountryReportFinding>Blocking was happening using DNS injection & SNI filtering</CountryReportFinding>
          </Appear>
          <Appear fid="4" order={4}>
            <CountryReportFinding>Technologies like DNS over TLS (DoT) and Encrypted SNI (ESNI) could help</CountryReportFinding>
          </Appear>
          <Appear fid="1" order={1}>
            <div>
            <CountryReportHeading>China is now blocking all language editions of Wikipedia</CountryReportHeading>
            <CountryReportDate>May 2019</CountryReportDate>
            <Link href='https://ooni.org/post/2019-china-wikipedia-blocking/'>https://ooni.org/post/2019-china-wikipedia-blocking/</Link>
            </div>
          </Appear>
        </Slide>
        ...
        <Slide transition={["fade"]} bgImage={images.FlagOfEgypt} bgDarken={0.7} bgSize='120%'>
          ...
          <Appear fid="2" order={2}>
            <CountryReportFinding>Protests erupted on the 21st of September following corruption allegation against the president</CountryReportFinding>
          </Appear>
          <Appear fid="3" order={3}>
            <CountryReportFinding>We found media websites, BBC and Alhurra to be blocking starting from the 22nd of September.
      </CountryReportFinding>
          </Appear>
          <Appear fid="4" order={4}>
            <CountryReportFinding>On Telecom Egypt we found the block to be implementing using SNI filtering</CountryReportFinding>
          </Appear>

          <Appear fid="1" order={1}>
            <div>
            <CountryReportHeading>Amid political unrest, Egypt blocks BBC and Alhurra</CountryReportHeading>
            <CountryReportDate>September 2019</CountryReportDate>
            <Link href='https://ooni.org/post/2019-egypt-blocks-bbc-and-alhurra/'>https://ooni.org/post/2019-egypt-blocks-bbc-and-alhurra/</Link>
            </div>
          </Appear>
        </Slide>

        <Slide transition={["fade"]} bgImage={images.WomenOnWavesCover} bgDarken={0.7} bgSize='120%'>
          <Image style={{'margin-top': '-300px'}} src={images.WomenOnWavesBlockingChart} />

            <CountryReportHeading>Blocking of abortion rights websites.</CountryReportHeading>
          <CountryReportDate>October 2019</CountryReportDate>
          <Link href='https://ooni.org/post/2019-blocking-abortion-rights-websites-women-on-waves-web/'>https://ooni.org/post/2019-blocking-abortion-rights-websites-women-on-waves-web/</Link>
        </Slide>
        ...
        <Slide transition={["fade"]} maxHeight="100vh" maxWidth="100vw" bgImage={images.OONIExplorerScreenshot}>
          <FloatingLink url='https://explorer.ooni.org' />
        </Slide>
        ...
        <Slide transition={["fade"]} bgImage={images.OONIBlob}>
          ...
          <FloatingLinkRight url='https://ooni.org/post/mining-ooni-data/' />
        </Slide>
        ...
        <Slide transition={["fade"]} bgColor="white">
          ...
          <Appear fid="1">
            <Heading size={2} caps fit textColor="primary">
              <BlueNumber>54</BlueNumber> published research reports
            </Heading>
          </Appear>
          <Appear fid="2">
            <Heading size={2} caps fit textColor="primary">
              Team of <BlueNumber>6</BlueNumber> people working full-time
            </Heading>
          </Appear>
          <Appear fid="3">
            <Heading size={2} caps fit textColor="primary">
        ...
        <Slide transition={["fade"]} bgColor="white">
          ...
          <ListItem><Link href="https://explorer.ooni.org/">https://explorer.ooni.org/</Link></ListItem>
