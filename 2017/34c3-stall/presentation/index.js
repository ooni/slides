...
const images = {
  ...
  ProbeHorizontalColor: require("ooni-components/components/svgs/logos/Probe-HorizontalColor.svg"),
...
const StyledQRCodeValue = styled.div`
    ...
    return (
      <Deck transition={["zoom", "slide"]} transitionDuration={500} theme={theme} autoplay={true} autoplayDuration={1000} controls={false}>
        ...
        <Slide transition={["fade"]} bgColor="secondary">
          ...
          <StyledQRCode hideText value="https://ooni.torproject.org/install" />
          <Image height="100px" src={images.ProbeHorizontalColor} />
        </Slide>
